...
import { MessageEmbed, User as DiscordUser, Guild as DiscordGuild, GuildMember, TextChannel } from "discord.js";
import { I18n } from 'i18n';
import { ReturnOptions } from "../interfaces/main";
...
export default class ContextMenuCommandExecution {
    TobyBot: TobyBot;
    Trigger: any;
    Command: Command;
    ...
    RealExecutor: DiscordUser;
    GuildExecutor: GuildMember;
    RealGuildExecutor: GuildMember;
    Channel: TextChannel;
    RealChannel: TextChannel;
    Guild: Guild;
    RealGuild: Guild;
    User: User;
    RealUser: User;
     ...
     */
     async replyEmbed(...args){
        ...
        return (<any>this.returnEmbed)(...args);
    }
    ...
    async replyRaw(...args){
        args[0] = Object.assign({followUpIfReturned: true}, args[0]) as ReturnOptions;
        if (args[0].slashOnly && !this.IsSlashCommand)return true;
        return this.returnRaw(...args);
    }

    async sendRaw(...args){
        if (args[0].slashOnly && !this.IsSlashCommand)return true;
        return (<any>this.Channel.send)(...args);
    }
}
...
module.exports = {
    ...
    async exec(client, message, args, guild = undefined) {
        ...
        embed.footer = {
            text: `Use \`${guild.configuration.prefix}notes <user> [page number]\` to search thru pages. [1/${embedPages.length}]`
        };
        ...
        if (args.length == 2) {
            ...
            embed.footer = {
                text: `Use \`${guild.configuration.prefix}notes <user> [page number]\` to search thru pages. [${args[1]}/${embedPages.length}]`
            };

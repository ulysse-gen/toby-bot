...
module.exports = {
    ...
    async execute(CommandExecution) {
        ...
        let ConfigurationFunctions = require('/app/configurations/functions/GuildConfiguration');
        await ConfigurationDocumentation.initialize();

        if (!ConfigurationManager.initialized)return CommandExecution.returnWarningEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.generic.configuration.first-init.title`), CommandExecution.i18n.__(`command.generic.configuration.first-init.description`, {}));

        if (CommandExecution.options.subCommand == "load"){
            await ConfigurationManager.load().catch(e => {
                CommandExecution.returnErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.generic.configuration.cannotload.title`), CommandExecution.i18n.__(`command.generic.configuration.cannotload.description`, {}));
            });
            CommandExecution.returnSuccessEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.loaded.title`), CommandExecution.i18n.__(`command.${this.name}.loaded.description`, {}));
            return true;
        }

        if (CommandExecution.options.subCommand == "save"){
            await ConfigurationManager.save().catch(e => {
                CommandExecution.returnErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.generic.configuration.cannotsave.title`), CommandExecution.i18n.__(`command.generic.configuration.cannotsave.description`, {}));
            });
            CommandExecution.returnSuccessEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.saved.title`), CommandExecution.i18n.__(`command.${this.name}.saved.description`, {}));
            return true;
        }
        ...
        if (CommandExecution.options.subCommand == "reset"){
            if (typeof CommandExecution.options.key == "undefined")return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.noKeySpecified.title`), CommandExecution.i18n.__(`command.${this.name}.error.noKeySpecified.description`, {}));
            
            let KeyDocumentation = ConfigurationDocumentation.get(CommandExecution.options.key);

            if (typeof KeyDocumentation != "object" || (typeof KeyDocumentation.editable != "boolean" || !KeyDocumentation.editable) || (typeof KeyDocumentation.name != "string" || typeof KeyDocumentation.description != "string" || typeof KeyDocumentation.type != "string"))return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.keyNotFound.title`), CommandExecution.i18n.__(`command.${this.name}.error.keyNotFound.description`, {}));
            ...
            CommandExecution.returnSuccessEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.reset.title`, { name: KeyName, key: CommandExecution.options.key }), CommandExecution.i18n.__(`command.${this.name}.reset.description`, { name: KeyName, key: CommandExecution.options.key }));
            return true;
        }

        if (CommandExecution.options.subCommand == "set"){
            if (typeof CommandExecution.options.key == "undefined")return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.noKeySpecified.title`), CommandExecution.i18n.__(`command.${this.name}.error.noKeySpecified.description`, {}));
            if (typeof CommandExecution.options.value == "undefined")return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.noValueSpecified.title`), CommandExecution.i18n.__(`command.${this.name}.error.noValueSpecified.description`, {}));
            ...
            if (KeyType.startsWith('String')){
                ...
                try {
                    ...
                    return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseJSON.title`), CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseJSON.description`, {error: e}));
                }
            }else if (["Integer"].includes(KeyType)){
                try {
                    KeyNewValue = parseInt(KeyNewValue);
                }catch (e) {
                    return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseInt.title`), CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseInt.description`, {error: e}));
                }
            }else if (["Float"].includes(KeyType)){
                try {
                    KeyNewValue = parseFloat(KeyNewValue);
                }catch (e) {
                    return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseFloat.title`), CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseFloat.description`, {error: e}));
                }
                ...
                if (["true","1","yes","y","oui","o"].includes(KeyNewValue)){
                    ...
                    return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseBoolean.title`), CommandExecution.i18n.__(`command.${this.name}.error.couldNotParseBoolean.description`, {}));
                }
            }else {
                return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.configCheckNotDefined.title`), CommandExecution.i18n.__(`command.${this.name}.error.configCheckNotDefined.description`, {}));
            }

            if (KeyType.startsWith('Object')) {
                if (_.isEqual(KeyValue, KeyNewValue))return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.configUnchanged.title`), CommandExecution.i18n.__(`command.${this.name}.error.configUnchanged.description`, {}));
            } else if (KeyValue == KeyNewValue)return CommandExecution.replyErrorEmbed({ephemeral: false}, CommandExecution.i18n.__(`command.${this.name}.error.configUnchanged.title`), CommandExecution.i18n.__(`command.${this.name}.error.configUnchanged.description`, {}));

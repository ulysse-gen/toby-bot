...
exports.getGuildConfiguration = async (req, res, next) => {
    ...
    try {
        ...
        if (Guild) {
            return res.status(200).json(_.omit(Guild.ConfigurationManager.configuration, ['system']));
        } else {
            return res.status(404).json(req.__('error.guild_not_found'));
        }
    } catch (error) {
...
exports.getGuildConfigurationKey = async (req, res, next) => {
    ...
    try {
        ...
        let ConfigurationDocumentation = new FileConfigurationManager('/app/configurations/documentations/GuildConfiguration.json', undefined, true);
        let ConfigurationFunctions = require('/app/configurations/functions/GuildConfiguration.js');
...
exports.getGuildMembers = async (req, res, next) => {
    const { guildId } = req.params;
...
exports.getGuildRoles = async (req, res, next) => {
    const { guildId } = req.params;
...
exports.getGuildChanels = async (req, res, next) => {
    const { guildId } = req.params;

...
const doNotReactToWords = ["react", "reply", "emoji", "emote", "eyes", "put", "emoticon", "respond", "place", "hate", "position", "case", "condition", "below", "under", "set", "please", "👀", "👁", "🥖", "uno", "card", "if","noted", "do"];

...
$configurationDocumentation = tobybotApiRequest("/v1/documentation/configuration/user");
?>
...
<section class="full-width documentation">
    ...
    <p class="section-description">The commands for user configuration is `userconfiguration`, it is accessible thru slash commands as well as normal commands using the bot prefix.<br />
    <span class="code-font">userconfiguration view &#60;configuration key&#62;<br />
    userconfiguration reset &#60;configuration key&#62;<br />
    userconfiguration set &#60;configuration key&#62; &#60;value&#62;</span></p>
    <br /><br />

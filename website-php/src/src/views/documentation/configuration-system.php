...
$configurationDocumentation = tobybotApiRequest("/v1/documentation/configuration/system");
if ($configurationDocumentation == "Token required."){
...
<section class="full-width documentation">
    <h2 class="section-title">System configuration</h1>
    <p class="section-description">The commands for system globalconfiguration is `configuration`, it is accessible thru slash commands as well as normal commands using the bot prefix.<br />
    <span class="code-font">globalconfiguration view &#60;configuration key&#62;<br />
    globalconfiguration reset &#60;configuration key&#62;<br />
    globalconfiguration set &#60;configuration key&#62; &#60;value&#62;</span></p>
    <br /><br />
